...
exports.verifyForgotMail = exports.sendForgotPasswordMail = exports.verifyUserMail = exports.sendVerificationMail = exports.signinUser = exports.signupUser = exports.transporter = void 0;
...
var verifyUserMail = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                decodedToken = jsonwebtoken_1.default.verify(token, JWT_KEY);
        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, exports.transporter.sendMail({
                        ...
                        // text: "Hello world?", // plain text body
                        html: "Your Verification for forgot password Link <a href=\"".concat(FRONTEND_URL, "/forgot-password-verify/").concat(jwtToken, "\">Link</a>"), // html body
                    })];
            case 4:
                info = _a.sent();
                // console.log("Preview URL: %s", nodemailer.getTestMessageUrl(info));
